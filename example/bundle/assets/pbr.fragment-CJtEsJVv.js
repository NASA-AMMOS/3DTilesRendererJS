import{by as e}from"./lil-gui.esm-BefRRnNM.js";import"./pbrDebug-Jqm28Kck.js";import"./pbrUboDeclaration-BLwQW2MZ.js";import"./logDepthDeclaration-B-nv4m_V.js";import"./helperFunctions-Dy59XMeY.js";import"./TilesRendererBase-DGV8eoZf.js";import"./constants-JFoaxC9y.js";import"./BatchTable-CRr3zuRk.js";import"./B3DMLoaderBase-w5mdSgm-.js";const n="pbrFragmentDeclaration",P=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=P);const a="samplerFragmentAlternateDeclaration",U=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=U);const t="pbrFragmentSamplersDeclaration",b=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=b);const o="bumpFragmentMainFunctions",X=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=X);const f="bumpFragmentFunctions",y=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=y);const r="decalFragment",B=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=B);const c="pbrBlockAlbedoOpacity",x=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=x);const l="pbrBlockReflectivity",H=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=H);const d="pbrBlockAmbientOcclusion",G=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=G);const s="pbrBlockAlphaFresnel",w=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=w);const E="pbrBlockAnisotropic",V=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=V);const R="pbrBlockReflection",W=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=W);const u="pbrBlockSheen",Y=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Y);const C="pbrBlockClearcoat",k=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=k);const S="pbrBlockIridescence",z=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=z);const m="pbrBlockSubSurface",K=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=K);const I="clusteredLightingFunctions",$=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=$);const A="pbrBlockReflectance0",q=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=q);const v="pbrClusteredLightingFunctions",Z=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=Z);const T="bumpFragment",J=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=J);const h="pbrBlockNormalFinal",Q=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Q);const p="pbrBlockLightmapInit",j=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=j);const O="pbrBlockGeometryInfo",ee=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ee);const L="pbrBlockReflectance",ie=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=ie);const N="pbrBlockDirectLighting",ne=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=ne);const g="lightFragment",ae=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=ae);const D="pbrBlockFinalLitComponents",te=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=te);const _="pbrBlockFinalUnlitComponents",oe=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=oe);const M="pbrBlockFinalColorComposition",fe=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=fe);const i="pbrPixelShader",F=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=F);const Se={name:i,shader:F};export{Se as pbrPixelShader};
//# sourceMappingURL=pbr.fragment-CJtEsJVv.js.map
