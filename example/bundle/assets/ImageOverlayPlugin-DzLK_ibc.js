import{g as Q,b8 as G,i as R,O as H,C as W,b as $,V as F,aM as J,k as Y,l as M,B as j,an as Z,b1 as K,ak as ee,aC as te,y as ne}from"./three.module-CzWreCHW.js";import{X as ie,T as ae}from"./TMSImageSource-COn7Tf_n.js";import{C as re,G as se}from"./GeometryClipper-3Ei2oHoO.js";import{P as oe,s as le}from"./TilesRenderer-D_LH0kgl.js";const ce=new H,he=new W;class ue{constructor(e){this.renderer=e,this.renderTarget=null,this.range=[0,0,1,1],this.quad=new Q(new G,new de)}setRenderTarget(e,n){this.renderTarget=e,this.range=[...n]}draw(e,n){const{range:t,renderer:i,quad:s,renderTarget:a}=this,r=s.material;r.map=e,r.minRange.x=R.mapLinear(n[0],t[0],t[2],-1,1),r.minRange.y=R.mapLinear(n[1],t[1],t[3],-1,1),r.maxRange.x=R.mapLinear(n[2],t[0],t[2],-1,1),r.maxRange.y=R.mapLinear(n[3],t[1],t[3],-1,1);const o=i.getRenderTarget(),h=i.autoClear;i.autoClear=!1,i.setRenderTarget(a),i.render(s,ce),i.setRenderTarget(o),i.autoClear=h,r.map=null}clear(e,n=1){const{renderer:t,renderTarget:i}=this,s=t.getRenderTarget(),a=t.getClearColor(he),r=t.getClearAlpha();t.setClearColor(e,n),t.setRenderTarget(i),t.clear(),t.setRenderTarget(s),t.setClearColor(a,r)}dispose(){this.quad.material.dispose(),this.quad.geometry.dispose()}}class de extends ${get minRange(){return this.uniforms.minRange.value}get maxRange(){return this.uniforms.maxRange.value}get map(){return this.uniforms.map.value}set map(e){this.uniforms.map.value=e}constructor(){super({depthWrite:!1,depthTest:!1,transparent:!1,side:J,premultipliedAlpha:!0,uniforms:{map:{value:null},minRange:{value:new F},maxRange:{value:new F}},vertexShader:`
