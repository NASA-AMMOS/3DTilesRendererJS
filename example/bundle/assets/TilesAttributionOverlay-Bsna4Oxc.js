import{r,d as x,j as t}from"./CameraControls-CQWLZjoh.js";import{C as y}from"./CanvasDOMOverlay-Dx1Xg4wU.js";function g(){return crypto.getRandomValues(new Uint32Array(1))[0].toString(16)}function j({children:d,style:m,generateAttributions:u,...p}){const s=r.useContext(x),[c,f]=r.useState([]);r.useEffect(()=>{if(!s)return;let i=!1;const e=()=>{i||(i=!0,queueMicrotask(()=>{f(s.getAttributions()),i=!1}))};return s.addEventListener("tile-visibility-change",e),s.addEventListener("load-tileset",e),()=>{s.removeEventListener("tile-visibility-change",e),s.removeEventListener("load-tileset",e)}},[s]);const n=r.useMemo(()=>"class_"+g(),[]),v=r.useMemo(()=>`
		#${n} a {
			color: white;
		}
...
//# sourceMappingURL=TilesAttributionOverlay-Bsna4Oxc.js.map
