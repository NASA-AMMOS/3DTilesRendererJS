import{i as Q,aP as H,M as I,O as $,C as W,b as J,V as F,aH as Z,l as Y,m as M,B as q,ao as K,aG as ee,al as te,aE as ne,I as ie}from"./three.module-B9KxNAP1.js";import{P as ae,s as re}from"./TilesRenderer-BsUNo_RK.js";import{C as se,G as oe}from"./GeometryClipper-BMnz8RV9.js";import{X as le,T as ce}from"./TMSImageSource-DVpwnITq.js";const he=new $,ue=new W;class de{constructor(e){this.renderer=e,this.renderTarget=null,this.range=[0,0,1,1],this.quad=new Q(new H,new me)}setRenderTarget(e,n){this.renderTarget=e,this.range=[...n]}draw(e,n){const{range:t,renderer:i,quad:s,renderTarget:a}=this,r=s.material;r.map=e,r.minRange.x=I.mapLinear(n[0],t[0],t[2],-1,1),r.minRange.y=I.mapLinear(n[1],t[1],t[3],-1,1),r.maxRange.x=I.mapLinear(n[2],t[0],t[2],-1,1),r.maxRange.y=I.mapLinear(n[3],t[1],t[3],-1,1);const o=i.getRenderTarget(),h=i.autoClear;i.autoClear=!1,i.setRenderTarget(a),i.render(s,he),i.setRenderTarget(o),i.autoClear=h,r.map=null}clear(e,n=1){const{renderer:t,renderTarget:i}=this,s=t.getRenderTarget(),a=t.getClearColor(ue),r=t.getClearAlpha();t.setClearColor(e,n),t.setRenderTarget(i),t.clear(),t.setRenderTarget(s),t.setClearColor(a,r)}dispose(){this.quad.material.dispose(),this.quad.geometry.dispose()}}class me extends J{get minRange(){return this.uniforms.minRange.value}get maxRange(){return this.uniforms.maxRange.value}get map(){return this.uniforms.map.value}set map(e){this.uniforms.map.value=e}constructor(){super({depthWrite:!1,depthTest:!1,transparent:!1,side:Z,premultipliedAlpha:!0,uniforms:{map:{value:null},minRange:{value:new F},maxRange:{value:new F}},vertexShader:`
