import{by as e}from"./lil-gui.esm-BefRRnNM.js";const t="sceneUboDeclaration",f=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;};
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const o="meshUboDeclaration",l=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=l);const a="mainUVVaryingDeclaration",c=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=c);const n="pbrBRDFFunctions",s=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=s);const r="harmonicsFunctions",d=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const i="logDepthDeclaration",v=`#ifdef LOGARITHMICDEPTH
uniform float logarithmicDepthConstant;varying float vFragmentDepth;
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=v);
//# sourceMappingURL=logDepthDeclaration-B-nv4m_V.js.map
