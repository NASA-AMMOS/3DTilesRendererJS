import{by as e}from"./lil-gui.esm-BefRRnNM.js";const f="sceneUboDeclaration",i=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=i);const r="meshUboDeclaration",c=`struct Mesh {world : mat4x4<f32>,
visibility : f32,};var<uniform> mesh : Mesh;
#define WORLD_UBO
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=c);const a="mainUVVaryingDeclaration",s=`#ifdef MAINUV{X}
varying vMainUV{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=s);const n="pbrBRDFFunctions",v=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=v);const t="harmonicsFunctions",d=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=d);const o="logDepthDeclaration",l=`#ifdef LOGARITHMICDEPTH
uniform logarithmicDepthConstant: f32;varying vFragmentDepth: f32;
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=l);
//# sourceMappingURL=logDepthDeclaration-Bs54FVVr.js.map
