...
`}}}}function Pt(){if(K||Q)return;z.setFromCamera(J,g);const n=z.intersectObject(S)[0];if(n){const{object:e,face:t,point:s,index:r,faceIndex:i}=n,o=new Ze,a=new ee;t?(o.setFromAttributeAndIndices(e.geometry.attributes.position,t.a,t.b,t.c),o.a.applyMatrix4(e.matrixWorld),o.b.applyMatrix4(e.matrixWorld),o.c.applyMatrix4(e.matrixWorld),o.getBarycoord(s,a)):(o.setFromAttributeAndIndices(e.geometry.attributes.position,r,r,r),o.a.applyMatrix4(e.matrixWorld),o.b.applyMatrix4(e.matrixWorld),o.c.applyMatrix4(e.matrixWorld),a.set(0,0,0));const{meshFeatures:u}=n.object.userData;u?(K=!0,u.getFeaturesAsync(i,a).then(c=>{K=!1,w={index:r,features:c,faceIndex:i,barycoord:a,object:e}})):w={index:r,features:null,faceIndex:i,barycoord:a,object:e}}else w=null}function Dt(){const{featureIndex:n}=A;let e=null,t=null,s=null;if(w&&(e=w.object.userData.meshFeatures,t=w.object.userData.structuralMetadata,s=w.features),e!==null&&s!==null){const{index:r,faceIndex:i,barycoord:o}=w;if(b.innerText=`EXT_MESH_FEATURES
