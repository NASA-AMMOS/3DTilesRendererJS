import{by as e}from"./lil-gui.esm-BefRRnNM.js";import"./pbrDebug-C3nhTNvE.js";import"./pbrUboDeclaration-DTYg2xWq.js";import"./logDepthDeclaration-Bs54FVVr.js";import"./helperFunctions-B107fqvM.js";import"./TilesRendererBase-DGV8eoZf.js";import"./constants-JFoaxC9y.js";import"./BatchTable-CRr3zuRk.js";import"./B3DMLoaderBase-w5mdSgm-.js";const a="samplerFragmentAlternateDeclaration",_=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=_);const r="pbrFragmentSamplersDeclaration",M=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=M);const n="bumpFragmentMainFunctions",D=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=D);const f="bumpFragmentFunctions",F=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=F);const t="decalFragment",P=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=P);const o="pbrBlockAlbedoOpacity",X=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=X);const c="pbrBlockReflectivity",U=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=U);const l="pbrBlockAmbientOcclusion",b=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=b);const d="pbrBlockAlphaFresnel",x=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=x);const s="pbrBlockAnisotropic",y=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=y);const m="pbrBlockReflection",B=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=B);const E="pbrBlockSheen",G=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=G);const S="pbrBlockClearcoat",H=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=H);const u="pbrBlockIridescence",w=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=w);const p="pbrBlockSubSurface",W=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=W);const R="bumpFragment",V=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=V);const v="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Y);const C="pbrBlockLightmapInit",k=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=k);const I="pbrBlockGeometryInfo",z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=z);const A="pbrBlockReflectance",K=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=K);const h="pbrBlockDirectLighting",$=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=$);const T="lightFragment",q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=q);const L="pbrBlockFinalLitComponents",Z=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=Z);const N="pbrBlockFinalUnlitComponents",Q=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=Q);const O="pbrBlockFinalColorComposition",J=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=J);const i="pbrPixelShader",g=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=g);const ce={name:i,shader:g};export{ce as pbrPixelShaderWGSL};
//# sourceMappingURL=pbr.fragment-mvAzXnzj.js.map
