...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=F);const r="openpbrFragmentSamplersDeclaration",L=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=L);const t="openpbrNormalMapFragmentMainFunctions",b=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=b);const a="openpbrNormalMapFragmentFunctions",O=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=O);const s="openpbrDielectricReflectance",C=`struct ReflectanceParams
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=C);const f="openpbrConductorReflectance",D=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=D);const l="openpbrAmbientOcclusionFunctions",M=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=M);const c="openpbrGeometryInfo",G=`struct geometryInfoOutParams
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=P);const m="openpbrNormalMapFragment",x=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=x);const _="openpbrBlockNormalFinal",z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=z);const u="openpbrBaseLayerData",y=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=U);const p="openpbrCoatLayerData",W=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=W);const I="openpbrThinFilmLayerData",X=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=X);const E="openpbrFuzzLayerData",B=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=B);const v="openpbrAmbientOcclusionData",H=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=H);const R="openpbrBackgroundTransmission",V=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=V);const h="openpbrEnvironmentLighting",w=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=w);const N="openpbrDirectLightingInit",k=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=k);const S="openpbrDirectLighting",Y=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=Y);const i="openpbrPixelShader",T=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=T);const oe={name:i,shader:T};export{oe as openpbrPixelShader};
//# sourceMappingURL=openpbr.fragment-CkjtOYud.js.map
