import{V as l,C as d,k as w,l as m,i as p,g as q}from"./three.module-CzWreCHW.js";const g=Symbol("TOPO_PARAMS"),Z=`
...
`;function G(r,t){if(r[g])return r[g];const o={resolution:{value:new l},pixelRatio:{value:1},ellipsoid:{value:new m},frame:{value:new w},topoColor:{value:new d},topoOpacity:{value:.5},topoLimit:{value:new l(0,1e10)},topoFadeLimit:{value:new l(0,1e10)},cartoColor:{value:new d},cartoOpacity:{value:.5},cartoLimit:{value:new l(0,1e10)},cartoFadeLimit:{value:new l(0,1e10)},thickness:{value:1}};return r[g]=o,r.defines={...r.defines||{},USE_TOPO_ELLIPSOID:0,USE_TOPO_LINES:0},r.onBeforeCompile=e=>{H(e),t&&t(e),e.uniforms={...e.uniforms,...o},e.vertexShader=e.vertexShader.replace(/void main\(/,i=>`
