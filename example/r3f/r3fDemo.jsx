...
function Additional3dObjects( { commonPluginsProps } ) {
	...
	const { lat, lon } = commonPluginsProps;
	return <>
...
const templateEmptyKey = 'put-your-api-key-here';
function App() {

	const googleApiKey_ = localStorage.getItem( 'Google3DCities.googleApiKey' ) || templateEmptyKey;
	const ionAccessToken_ = localStorage.getItem( 'CesiumIon.ionAccessToken' ) || templateEmptyKey;
	...
	// onChange: 'onChangeLeva', // cannot be applied at object level
		debug: false,
		fade: { value: true, disabled: false },
		lon_lat_height: {
