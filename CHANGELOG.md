...
- AdaptiveErrorTargetPlugin: Add plugin that iteratively raises "errorTarget" while the cache is full and refusing tiles, and steps it back down once the cache has room again.
