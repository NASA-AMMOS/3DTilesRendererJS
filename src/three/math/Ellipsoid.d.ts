...
export class Ellipsoid {
	...
	getAzElRollFromRotationMatrix( lat: Number, lon: Number, frame: Matrix4, target: Object ): { azimuth: Number, elevation: Number, roll: Number };
	getRotationMatrixFromAzElRoll( lat: Number, lon: Number, az: Number, el: Number, roll: Number, target: Matrix4 ): Matrix4;
